...
namespace RootMotion {
    ...
    public class Interp {
        ...
        public static float LerpValue(float value, float target, float increaseSpeed, float decreaseSpeed) {
            ...
            return value < target ? Mathf.Clamp(value + Time.deltaTime * increaseSpeed, -Mathf.Infinity, target) : Mathf.Clamp(value - Time.deltaTime * decreaseSpeed, target, Mathf.Infinity);
        }
