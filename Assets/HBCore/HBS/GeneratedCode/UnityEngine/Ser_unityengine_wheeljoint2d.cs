...
using System;
namespace HBS {
    public static class Ser_unityengine_wheeljoint2d {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.WheelJoint2D o = (UnityEngine.WheelJoint2D)oo;
            writer.Write(14);

            writer.Write("suspension");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_jointsuspension2d.Ser( writer_ASXDRGBHU , o.suspension); //property
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            for (int i_ASXDRGBHU = 0; i_ASXDRGBHU < count_ASXDRGBHU; i_ASXDRGBHU++) {
                ...
                if (name_ASXDRGBHU == "suspension") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.suspension = (UnityEngine.JointSuspension2D)HBS.Ser_unityengine_jointsuspension2d.Res( reader_ASXDRGBHU ); //property
