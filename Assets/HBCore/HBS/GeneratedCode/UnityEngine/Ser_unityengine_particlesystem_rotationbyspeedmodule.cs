...
using System;
namespace HBS {
    public static class Ser_unityengine_particlesystem_rotationbyspeedmodule {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.ParticleSystem.RotationBySpeedModule o = (UnityEngine.ParticleSystem.RotationBySpeedModule)oo;
            writer.Write(9);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.ParticleSystem.RotationBySpeedModule o = new UnityEngine.ParticleSystem.RotationBySpeedModule();
