...
using System;
namespace HBS {
    public static class Ser_unityengine_characterjoint {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.CharacterJoint o = (UnityEngine.CharacterJoint)oo;
            writer.Write(22);

            writer.Write("swingAxis");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_vector3.Ser( writer_ASXDRGBHU , o.swingAxis); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("twistLimitSpring");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_softjointlimitspring.Ser( writer_ASXDRGBHU , o.twistLimitSpring); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("swingLimitSpring");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_softjointlimitspring.Ser( writer_ASXDRGBHU , o.swingLimitSpring); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("lowTwistLimit");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_softjointlimit.Ser( writer_ASXDRGBHU , o.lowTwistLimit); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("highTwistLimit");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_softjointlimit.Ser( writer_ASXDRGBHU , o.highTwistLimit); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("swing1Limit");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_softjointlimit.Ser( writer_ASXDRGBHU , o.swing1Limit); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("swing2Limit");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_softjointlimit.Ser( writer_ASXDRGBHU , o.swing2Limit); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("enableProjection");
            writer_ASXDRGBHU = new HBS.Writer();
            writer_ASXDRGBHU.Write(o.enableProjection); //property primitive
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            for (int i_ASXDRGBHU = 0; i_ASXDRGBHU < count_ASXDRGBHU; i_ASXDRGBHU++) {
                ...
                if (name_ASXDRGBHU == "swingAxis") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.swingAxis = (UnityEngine.Vector3)HBS.Ser_unityengine_vector3.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "twistLimitSpring") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.twistLimitSpring = (UnityEngine.SoftJointLimitSpring)HBS.Ser_unityengine_softjointlimitspring.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "swingLimitSpring") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.swingLimitSpring = (UnityEngine.SoftJointLimitSpring)HBS.Ser_unityengine_softjointlimitspring.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "lowTwistLimit") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.lowTwistLimit = (UnityEngine.SoftJointLimit)HBS.Ser_unityengine_softjointlimit.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "highTwistLimit") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.highTwistLimit = (UnityEngine.SoftJointLimit)HBS.Ser_unityengine_softjointlimit.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "swing1Limit") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.swing1Limit = (UnityEngine.SoftJointLimit)HBS.Ser_unityengine_softjointlimit.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "swing2Limit") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.swing2Limit = (UnityEngine.SoftJointLimit)HBS.Ser_unityengine_softjointlimit.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "enableProjection") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.enableProjection = (System.Boolean)reader_ASXDRGBHU.Read(); //property primitive
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }
