...
using System;
namespace HBS {
    public static class Ser_unityengine_experimental_director_playable {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.Experimental.Director.Playable o = (UnityEngine.Experimental.Director.Playable)oo;
            writer.Write(1);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.Experimental.Director.Playable o = new UnityEngine.Experimental.Director.Playable();
