...
using System;
namespace HBS {
    public static class Ser_unityengine_missingcomponentexception {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.MissingComponentException o = (UnityEngine.MissingComponentException)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.MissingComponentException o = new UnityEngine.MissingComponentException();
