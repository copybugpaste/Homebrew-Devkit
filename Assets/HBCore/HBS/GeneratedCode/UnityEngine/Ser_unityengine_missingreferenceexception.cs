...
using System;
namespace HBS {
    public static class Ser_unityengine_missingreferenceexception {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.MissingReferenceException o = (UnityEngine.MissingReferenceException)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.MissingReferenceException o = new UnityEngine.MissingReferenceException();
