...
using System;
namespace HBS {
    public static class Ser_unityengine_ai_navmeshqueryfilter {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.AI.NavMeshQueryFilter o = (UnityEngine.AI.NavMeshQueryFilter)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.AI.NavMeshQueryFilter o = new UnityEngine.AI.NavMeshQueryFilter();
