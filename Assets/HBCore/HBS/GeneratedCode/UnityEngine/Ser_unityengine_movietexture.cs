...
using System;
namespace HBS {
    public static class Ser_unityengine_movietexture {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.MovieTexture o = (UnityEngine.MovieTexture)oo;
            writer.Write(10);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.MovieTexture o = new UnityEngine.MovieTexture();
