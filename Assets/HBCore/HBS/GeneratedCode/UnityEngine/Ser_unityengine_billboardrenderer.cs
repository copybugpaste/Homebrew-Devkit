...
using System;
namespace HBS {
    public static class Ser_unityengine_billboardrenderer {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.BillboardRenderer o = (UnityEngine.BillboardRenderer)oo;
            writer.Write(21);

            writer.Write("billboard");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_billboardasset.Ser( writer_ASXDRGBHU , o.billboard); //property
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            for (int i_ASXDRGBHU = 0; i_ASXDRGBHU < count_ASXDRGBHU; i_ASXDRGBHU++) {
                ...
                if (name_ASXDRGBHU == "billboard") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.billboard = (UnityEngine.BillboardAsset)HBS.Ser_unityengine_billboardasset.Res( reader_ASXDRGBHU ); //property
