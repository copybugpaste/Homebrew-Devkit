...
using System;
namespace HBS {
    public static class Ser_unityengine_assetbundlerequest {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.AssetBundleRequest o = (UnityEngine.AssetBundleRequest)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.AssetBundleRequest o = new UnityEngine.AssetBundleRequest();
