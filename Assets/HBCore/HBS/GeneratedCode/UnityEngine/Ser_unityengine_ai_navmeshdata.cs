...
using System;
namespace HBS {
    public static class Ser_unityengine_ai_navmeshdata {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.AI.NavMeshData o = (UnityEngine.AI.NavMeshData)oo;
            writer.Write(4);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.AI.NavMeshData o = new UnityEngine.AI.NavMeshData();
