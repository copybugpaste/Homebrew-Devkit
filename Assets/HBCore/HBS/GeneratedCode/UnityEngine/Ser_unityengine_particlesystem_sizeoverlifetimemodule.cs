...
using System;
namespace HBS {
    public static class Ser_unityengine_particlesystem_sizeoverlifetimemodule {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.ParticleSystem.SizeOverLifetimeModule o = (UnityEngine.ParticleSystem.SizeOverLifetimeModule)oo;
            writer.Write(10);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.ParticleSystem.SizeOverLifetimeModule o = new UnityEngine.ParticleSystem.SizeOverLifetimeModule();
