...
using System;
namespace HBS {
    public static class Ser_unityengine_particlesystem_velocityoverlifetimemodule {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.ParticleSystem.VelocityOverLifetimeModule o = (UnityEngine.ParticleSystem.VelocityOverLifetimeModule)oo;
            writer.Write(8);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.ParticleSystem.VelocityOverLifetimeModule o = new UnityEngine.ParticleSystem.VelocityOverLifetimeModule();
