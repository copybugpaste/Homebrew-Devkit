...
using System;
namespace HBS {
    public static class Ser_unityengine_assetbundlecreaterequest {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.AssetBundleCreateRequest o = (UnityEngine.AssetBundleCreateRequest)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.AssetBundleCreateRequest o = new UnityEngine.AssetBundleCreateRequest();
