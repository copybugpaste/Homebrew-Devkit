...
using System;
namespace HBS {
    public static class Ser_unityengine_boundingsphere {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.BoundingSphere o = (UnityEngine.BoundingSphere)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.BoundingSphere o = new UnityEngine.BoundingSphere();
