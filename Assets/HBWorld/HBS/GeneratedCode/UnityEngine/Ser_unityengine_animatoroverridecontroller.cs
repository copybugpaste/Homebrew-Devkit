...
using System;
namespace HBS {
    public static class Ser_unityengine_animatoroverridecontroller {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.AnimatorOverrideController o = (UnityEngine.AnimatorOverrideController)oo;
            writer.Write(3);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.AnimatorOverrideController o = new UnityEngine.AnimatorOverrideController();
