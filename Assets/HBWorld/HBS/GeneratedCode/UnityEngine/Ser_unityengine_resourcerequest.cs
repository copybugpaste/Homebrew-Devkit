...
using System;
namespace HBS {
    public static class Ser_unityengine_resourcerequest {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.ResourceRequest o = (UnityEngine.ResourceRequest)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.ResourceRequest o = new UnityEngine.ResourceRequest();
