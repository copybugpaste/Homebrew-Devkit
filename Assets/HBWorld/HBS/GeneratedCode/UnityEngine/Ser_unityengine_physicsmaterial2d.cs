...
using System;
namespace HBS {
    public static class Ser_unityengine_physicsmaterial2d {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.PhysicsMaterial2D o = (UnityEngine.PhysicsMaterial2D)oo;
            writer.Write(4);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.PhysicsMaterial2D o = new UnityEngine.PhysicsMaterial2D();
