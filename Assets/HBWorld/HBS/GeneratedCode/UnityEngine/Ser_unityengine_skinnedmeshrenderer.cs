...
using System;
namespace HBS {
    public static class Ser_unityengine_skinnedmeshrenderer {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.SkinnedMeshRenderer o = (UnityEngine.SkinnedMeshRenderer)oo;
            writer.Write(27);

            writer.Write("bones");
            writer_ASXDRGBHU = new HBS.Writer();
            if( writer_ASXDRGBHU.WriteNull(o.bones) == false ) {
                writer_ASXDRGBHU.Write(o.bones.Length);
                for( int i = 0; i < o.bones.Length; i++ ) {
                    HBS.Serializer.SerializePath(writer_ASXDRGBHU,o.bones[i]); //property component or gameObject
                }
            }
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("rootBone");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Serializer.SerializePath(writer_ASXDRGBHU,o.rootBone); //property component or gameObject
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("quality");
            writer_ASXDRGBHU = new HBS.Writer();
            HBS.Ser_unityengine_skinquality.Ser( writer_ASXDRGBHU , o.quality); //property
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();
            ...
            writer_ASXDRGBHU = new HBS.Writer();
            writer_ASXDRGBHU.Write(o.updateWhenOffscreen); //property primitive
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();

            writer.Write("skinnedMotionVectors");
            writer_ASXDRGBHU = new HBS.Writer();
            writer_ASXDRGBHU.Write(o.skinnedMotionVectors); //property primitive
            writer.Write(writer_ASXDRGBHU.stream.ToArray());
            writer_ASXDRGBHU.Close();
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            for (int i_ASXDRGBHU = 0; i_ASXDRGBHU < count_ASXDRGBHU; i_ASXDRGBHU++) {
                ...
                if (name_ASXDRGBHU == "bones") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        if( reader_ASXDRGBHU.ReadNull() == false ) {
                            UnityEngine.Transform[] bones_arr = new UnityEngine.Transform[(int)reader_ASXDRGBHU.Read()];
                            for( int i = 0; i < bones_arr.Length; i++ ) {
                                bones_arr[i] = (UnityEngine.Transform)HBS.Serializer.UnserializePath(reader_ASXDRGBHU); //property component or gameobject
                            }
                            o.bones = bones_arr;
                        }
                ...
                if (name_ASXDRGBHU == "rootBone") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.rootBone = (UnityEngine.Transform)HBS.Serializer.UnserializePath(reader_ASXDRGBHU); //property component or gameobject
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }
                ...
                if (name_ASXDRGBHU == "quality") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.quality = (UnityEngine.SkinQuality)HBS.Ser_unityengine_skinquality.Res( reader_ASXDRGBHU ); //property
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }
                ...
                if (name_ASXDRGBHU == "updateWhenOffscreen") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.updateWhenOffscreen = (System.Boolean)reader_ASXDRGBHU.Read(); //property primitive
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }

                if (name_ASXDRGBHU == "skinnedMotionVectors") {
                    try {
                        reader_ASXDRGBHU = new HBS.Reader(data_ASXDRGBHU);
                        o.skinnedMotionVectors = (System.Boolean)reader_ASXDRGBHU.Read(); //property primitive
                        reader_ASXDRGBHU.Close();
                    } catch { }
                }
