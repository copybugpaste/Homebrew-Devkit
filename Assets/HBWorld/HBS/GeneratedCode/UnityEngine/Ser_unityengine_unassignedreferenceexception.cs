...
using System;
namespace HBS {
    public static class Ser_unityengine_unassignedreferenceexception {
        public static void Ser( HBS.Writer writer , object oo ) {
            if( writer.WriteNull(oo)) { return; }
            HBS.Writer writer_ASXDRGBHU;
            UnityEngine.UnassignedReferenceException o = (UnityEngine.UnassignedReferenceException)oo;
            writer.Write(2);
        ...
        public static object Res( HBS.Reader reader, object oo = null) {
            ...
            UnityEngine.UnassignedReferenceException o = new UnityEngine.UnassignedReferenceException();
